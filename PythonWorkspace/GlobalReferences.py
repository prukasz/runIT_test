...
from GlobalStorage import GlobalStorage, ScalarItem, ArrayItem

@dataclass
class Global_reference:
    target_alias: str
    target_type_id: int     # Enum Value (
